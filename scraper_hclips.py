"""
Blue Tube - HClips.com Scraper
Scrapes video content from hclips.com
"""
...
class HClipsScraper:
    """Scraper for hclips.com website"""
    
    def __init__(self):
        self.base_url = "https://hclips.com"
        self.headers = {
    ...
    def scrape_homepage(self, max_videos: int = 500) -> List[Dict]:
        ...
        print(f"Scraping HClips.com for up to {max_videos} videos...")
        ...
        try:
            while len(videos) < max_videos:
                ...
                for element in video_elements:
                    ...
                    try:
                        ...
                        if video_data:
                            video_data['id'] = f"hclips_{len(videos) + 1}"
                            video_data['source'] = 'hclips.com'
            ...
            print(f"\n✅ HClips: Scraped {len(videos)} videos from {page} pages")
            return videos
    ...
    def _extract_video_data(self, element) -> Optional[Dict]:
        ...
        if link:
            ...
            if match:
                ...
                video_data['embed_url'] = f"https://hclips.com/embed/{video_id}"
...
def main():
    """Test the scraper"""
    scraper = HClipsScraper()
    videos = scraper.scrape_homepage(max_videos=300)
    
    if videos:
        print(f"\n✅ Total: {len(videos)} videos from HClips.com")
        with open('hclips_videos.json', 'w', encoding='utf-8') as f:
            json.dump(videos, f, indent=2, ensure_ascii=False)
        print("Saved to hclips_videos.json")
