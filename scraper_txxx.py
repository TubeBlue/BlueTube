"""
Blue Tube - Txxx.com Scraper
Scrapes video content from txxx.com
"""
...
class TxxxScraper:
    """Scraper for txxx.com website"""
    
    def __init__(self):
        self.base_url = "https://txxx.com"
        self.headers = {
    ...
    def scrape_homepage(self, max_videos: int = 500) -> List[Dict]:
        ...
        print(f"Scraping Txxx.com for up to {max_videos} videos...")
        ...
        try:
            while len(videos) < max_videos:
                ...
                for element in video_elements:
                    ...
                    try:
                        ...
                        if video_data:
                            video_data['id'] = f"txxx_{len(videos) + 1}"
                            video_data['source'] = 'txxx.com'
            ...
            print(f"\n✅ Txxx: Scraped {len(videos)} videos from {page} pages")
            return videos
    ...
    def _extract_video_data(self, element) -> Optional[Dict]:
        ...
        link = element.find('a', class_='thumb')
        if link:
            ...
            if match:
                ...
                video_data['embed_url'] = f"https://txxx.com/embed/{video_id}/"
        
        # Get title
        title_elem = element.find('div', class_='thumb-title') or element.find('a', {'title': True})
        if title_elem:
...
def main():
    ...
    if videos:
        print(f"\n✅ Total: {len(videos)} videos from Txxx.com")
        with open('txxx_videos.json', 'w', encoding='utf-8') as f:
            json.dump(videos, f, indent=2, ensure_ascii=False)
        print("Saved to txxx_videos.json")
