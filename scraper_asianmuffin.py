"""
Blue Tube - AsianMuffin.com Scraper
Scrapes video content from asianmuffin.com
"""
...
class AsianMuffinScraper:
    """Scraper for asianmuffin.com website"""
    
    def __init__(self):
        self.base_url = "https://www.asianmuffin.com"
        self.headers = {
    ...
    def scrape_homepage(self, max_videos: int = 500) -> List[Dict]:
        ...
        print(f"Scraping AsianMuffin.com for up to {max_videos} videos...")
        ...
        try:
            while len(videos) < max_videos:
                ...
                for element in video_elements:
                    ...
                    try:
                        ...
                        if video_data:
                            video_data['id'] = f"asianmuffin_{len(videos) + 1}"
                            video_data['source'] = 'asianmuffin.com'
            ...
            print(f"\n✅ AsianMuffin: Scraped {len(videos)} videos from {page} pages")
            return videos
    ...
    def _extract_video_data(self, element) -> Optional[Dict]:
        ...
        if link:
            ...
            if match:
                ...
                video_data['embed_url'] = f"https://www.asianmuffin.com/embed/{video_id}"
...
def main():
    """Test the scraper"""
    scraper = AsianMuffinScraper()
    videos = scraper.scrape_homepage(max_videos=300)
    
    if videos:
        print(f"\n✅ Total: {len(videos)} videos from AsianMuffin.com")
        with open('asianmuffin_videos.json', 'w', encoding='utf-8') as f:
            json.dump(videos, f, indent=2, ensure_ascii=False)
        print("Saved to asianmuffin_videos.json")
